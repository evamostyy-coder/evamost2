...
interface UseDigitsTradingReturn {
  ...
  /** Shared price buffer — forwarded to the bot for strategy evaluation. */
  prices: number[];
  tradeType: TradeType;
  ...
  clearSellError: () => void;
  /** Authenticated WS instance — forwarded to the bot for buy + settlement. */
  tradingWs: DerivWS | null;
}
